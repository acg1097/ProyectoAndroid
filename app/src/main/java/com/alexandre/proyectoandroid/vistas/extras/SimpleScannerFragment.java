        ...
        if(rawResult.getBarcodeFormat().equals(BarcodeFormat.CODE_128)){
            ...
            if(mobiliario==null){
                ...
                if (mobiliario.getEstado().toString().equals("En almacén")) {
                    ed.enviarCodigo(rawResult.getText());
                    mScannerView.setFlash(false);
            ...
            Toast.makeText(this.getContext(), rawResult.getText(),Toast.LENGTH_LONG).show();
        }else{
